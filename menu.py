...
class MAIN:
   ...
   def Me(self):
       self.MyRich("""\n[red]  _________  _______    ___ ___    __ __      _____    _______\n  \______  \ \_____ \  /   |   \  /  v  \    /  _  \   \      \  
   |      _/ /   |   \/    ~    \/  \ /  \  /  /_\  \  /   |   \ [blue]
   |   |   \/    |    \    Y    /    Y    \/    |    \/    |    \  
   |___|_  /\_______  /\___|_  /\____|__  /\____|__  /\____|__  /
         \/         \/       \/         \/         \/         \/   \n\n       [underline white]Version :[underline blue] 4.0[underline white] || Author :[underline green] RoHmaN[underline white] || Status :[underline blue] Premium""")
